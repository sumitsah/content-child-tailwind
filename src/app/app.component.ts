...
1. PARENT VIEW (e.g., AppComponent)
   │
  ...
  It comes down to ownership of the HTML tags:Who wrote the tag? 
    If a tag is written inside app.component.html, the AppComponent class owns that layout view.
  Who can query it? 
...
[LEVEL 1] Parent Component  ──► AppComponent (owns the files/layout)
   │
